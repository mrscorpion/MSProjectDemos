...
//#define kGradientBottomColor [UIColor colorWithRed:0.f green:0.f blue:0.f alpha:0.7]
#define kGradientBottomColor [UIColor colorWithRed:1.f green:1.f blue:1.f alpha:0.8]

//top color white value in gradient bg
//#define kGradientTopColor [UIColor colorWithRed:1.f green:1.f blue:1.f alpha:kBoxAlpha]
//#define kGradientTopColor [UIColor colorWithRed:0.f green:0.f blue:0.f alpha:0.7]
#define kGradientTopColor [UIColor colorWithRed:1.f green:1.f blue:1.f alpha:0.3]
