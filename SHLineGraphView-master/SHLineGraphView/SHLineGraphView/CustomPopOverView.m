...
- (void)setLayerFrame:(CGRect)frame
{
    ...
    self.popLayer.fillColor = _layerColor? _layerColor.CGColor : [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.7].CGColor;
}
...
- (void)initDefaultConfig
{
    ...
    _config.containerViewCornerRadius = 3.0;
    _config.roundMargin = 3.0;//10.0;
...
//    self.containerView.backgroundColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.7];
}
...
- (void)updateSubViewFrames
{
    ...
    containerViewFrame.origin.y =  CGRectGetMaxY(newFrame) - 8; //CGRectGetMaxY(newFrame) + 5;
