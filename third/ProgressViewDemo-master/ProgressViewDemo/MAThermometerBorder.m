...
//        CGPoint origin = CGPointMake(_upperCircleSecond.x, _lowerCircleFirst.y + diff*i/8.f + diff/16.f); ／／从右向左方向
//        CGPoint origin = CGPointMake(_upperCircleFirst.x, _lowerCircleFirst.y + diff*i/8.f + diff/16.f);
//        CGPoint dest = CGPointMake(origin.x - 0.6f * (_upperCircleSecond.x -_upperCircleFirst.x) , origin.y); // 向左突出
        
        // 从左向右方向
//        CGPoint origin = CGPointMake(_upperCircleFirst.x + 2, _lowerCircleFirst.y + diff*i/8.f + diff/16.f);
        CGPoint origin = CGPointMake(_upperCircleFirst.x + 5, _lowerCircleFirst.y + diff*i/8.f);
        CGPoint dest = CGPointMake(origin.x + 0.3f * (_upperCircleSecond.x -_upperCircleFirst.x) , origin.y);
