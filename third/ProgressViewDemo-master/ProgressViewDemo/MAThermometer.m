...
-(void)customInit
{
    ...
    _lineWidth              = _height/50.f; //_height/100.f;
    ...
    LXWave *wave = [[LXWave alloc] initWithFrame:CGRectMake(_upperCircleFirst.x, _lowerCircleFirst.y + diff*7/8.f, _upperCircleRadius * 2, -diff+diff*1/8.f)];
    wave.progress = 0.0f;
